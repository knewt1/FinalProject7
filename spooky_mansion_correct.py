...
entranceHall["items"].append("Some Spooky Paintings")
...
basement["items"].append("Cleaning Supplies")
...
attic2["items"].append("A Creepy Doll")
...
kitchen["items"].append("Canned Tuna")
