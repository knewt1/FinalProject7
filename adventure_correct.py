...
artroom = create_room("artroom", "You are in an artist's studio. Let's see your best painting.")
...
create_exit(hallway, artroom, "A door leads off one side of the hall.")               #WHY ISNT THIS WORKING??
create_exit(artroom, hallway, "You can only go back the way you came in.")
